from sqlalchemy import create_engine, Column, Integer, String, Boolean, DECIMAL, Date, DateTime, MetaData, Table, inspect
...
db_url_for_mysql = "mysql+mysqlconnector://root:1997Rasengan.70!@localhost:3306/php_my_admin"
